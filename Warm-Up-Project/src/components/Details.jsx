    ...
    (<div className='relative w-[80%] h-full flex justify-between items-center bg-red-0 m-auto py-[10%] px-[2%]'>
        ...
        <div className='p-5 content flex flex-col gap-2'>
            ...
            <div className='flex gap-4'>
                <Link className='px-6 py-1 border-blue-400 text-blue-400 border-1 w-fit text-[1.7vw] rounded-full hover:bg-blue-400 hover:text-white'>Edit</Link>
                <Link className='px-6 py-1 border-red-400 text-red-400 border-1 w-fit text-[1.7vw] rounded-full hover:bg-red-400 hover:text-white'>Delete</Link>
